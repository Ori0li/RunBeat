...
const EditProfile = ({
  ...
  const pickImage = async () => {
    try {
      ...
      if (!result.canceled) {
        try {
          console.log("선택된 이미지:", result.assets[0]);
          ...
          const uploadedImageUrl = await uploadProfileImage(formData);
          ...
          >
            <View style={styles.profileImage}>
              {profileImage ? (
                ...
                <Image
                  source={{
                    uri: "https://final-team.s3.ap-northeast-2.amazonaws.com/profiles/default.jpg",
                  }}
                  style={styles.profileImageContent}
                />
              )}
